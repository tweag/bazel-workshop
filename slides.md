...
<!-- note: It supports complex workflow, for example generating documentation for code or API -->
...
<!-- notes: there is also builtin rules for Java -->
...
<!-- notes: "execroot" contains for example the resources/data file exported (symlinked) with the binary artifacts. -->
